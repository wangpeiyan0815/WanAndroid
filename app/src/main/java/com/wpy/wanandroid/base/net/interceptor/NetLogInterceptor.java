package com.wpy.wanandroid.base.net.interceptor;
...
public class NetLogInterceptor implements Interceptor {
        ...
        if(isOpenLog){
            if (requestBody != null) {
                ...
                logRetrofitRequest(
                        method,
                        requestUrl == null ? null : requestUrl.toString(),
                        App.Companion.getApp().getResources().getString(
    ...
    private void logRetrofitRequest(
        ...
        if(headers!=null&&headers.size()>0){
            ...
            if(sbHeader.toString().trim().isEmpty()){
                Logger.t(Constant.NET_LOG_TAG).d(String.format(Constant.NET_REQUEST_HEADER, App.Companion.getApp().getResources().getString(
    ...
    private void logRetrofitResponseSuccess(
        ...
        if(headers!=null&&headers.size()>0){
            ...
            if(sbHeader.toString().trim().isEmpty()){
                Logger.t(Constant.NET_LOG_TAG).d(String.format(Constant.NET_RESPONSE_HEADER,App.Companion.getApp().getResources().getString(
